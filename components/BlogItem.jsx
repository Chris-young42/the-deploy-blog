...
const BlogItem = () => {
  return (
    <div className='max-w-[330px] sm:max-w-[300px] bg-white border-black hover:shadow-[-7px_7px_0px_#000000]'>
      <Image src={blog_data[0].image} alt='my-blog' width={400} height={400} className='border-b border-black' />
      <p className='ml-5 px-1 mt-5 inline-block bg-black text-white text-sm'>{blog_data[0].category}</p>
      <div className="p-5">
