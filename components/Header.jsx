    ...
    return (
        <div className='py-5 px-5 md:px-12 lg:px-28'>
            <div className='flex justify-between items-center'>
                ...
                <button
                    className='flex items-center gap-2 font-medium py-1 px-3 sm:py-3 sm:px-6 border border-solid border-black shadow-[-7px_7px_0px_#000000]'>Get Started<Image src={assets.arrow} alt='my-blog' /></button>
            </div>
            <div className='text-center my-8'>
                ...
                >
                    <input type="email" placeholder='输入你的邮箱' className='pl-4 outline-none' />
